    ...
    public static function statusToEmailMessage(Order $order) : array{
        ...
        switch($status){
            case 0:
                ...
                Nous avons enregistrée votre commande <a href='http://www.bebes-lutins.fr/commandes/$order_id'>#$order_id</a> du $order_date
            ...
            case 1:
                ...
                $message = "
                Bonjour $firstname_lastname,<BR>
                Nous avons bien reçu le paiement de votre commande <a href='http://www.bebes-lutins.fr/commandes/$order_id'>#$order_id</a> du $order_date.
            ...
            case 2:
                ...
                $message = "
                Bonjour $firstname_lastname,<BR>
                Votre commande <a href='http://www.bebes-lutins.fr/commandes/$order_id'>#$order_id</a> du $order_date vient de quitter notre atelier et devrait arriver 
            ...
            case 22:
                ...
                $message = "
                Bonjour $firstname_lastname,<BR>
                Votre commande <a href='http://www.bebes-lutins.fr/commandes/$order_id'>#$order_id</a> du $order_date est prête à être retiré à notre atelier.<BR>
            ...
            case 3:
                ...
                $message = "
                Bonjour $firstname_lastname,<BR>
                Votre commande <a href='http://www.bebes-lutins.fr/commandes/$order_id'>#$order_id</a> du $order_date vous a été livré, elle est donc terminée.<BR>
            ...
            case 33:
                ...
                $message = "
                Bonjour $firstname_lastname,<BR>
                Votre participation <a href='http://www.bebes-lutins.fr/commandes/$order_id'>#$order_id</a> du $order_date a bien été enregistrée.<BR>";
                break;
            case -1:
                $title = "Votre commande a été annulée";
                $message = "
                Bonjour $firstname_lastname,<BR>
                Votre commande <a href='http://www.bebes-lutins.fr/commandes/$order_id'>#$order_id</a> du $order_date a bien été annulée.<BR>
            ...
            case -2:
                ...
                $message = "
                Bonjour $firstname_lastname,<BR>
                Le paiement de votre commande <a href='http://www.bebes-lutins.fr/commandes/$order_id'>#$order_id</a> du $order_date est en train d'être vérifié.<BR>
            ...
            case -3:
                ...
                commande <a href='http://www.bebes-lutins.fr/commandes/$order_id'>#$order_id</a> du $order_date.<BR>
            ...
            default:
                ...
                $message = "
                Bonjour $firstname_lastname,<BR>
                Votre commande <a href='http://www.bebes-lutins.fr/commandes/$order_id'>#$order_id</a> du $order_date a changé d'état. Il nous est malheureusement impossible de déterminer l'état
