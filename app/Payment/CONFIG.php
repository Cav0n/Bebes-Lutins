<?php
	...
	DEFINE( 'CANCEL_URL', 'https://www.bebes-lutins.fr/cancel_payment');
	DEFINE( 'NOTIFICATION_URL','https://www.bebes-lutins.fr/notification_payment');
	DEFINE( 'RETURN_URL', 'https://www.bebes-lutins.fr/payment_endpoint');
