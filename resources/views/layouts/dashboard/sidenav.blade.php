<div id='sidenav' class="col-3 d-none d-lg-flex flex-column">
    <a href='/dashboard/commandes/en-cours' class='text-dark @if(Request::is('*/commandes*')) active @endif'><img src='{{asset('images/icons/orders1.svg')}}' style='width:2.4rem;'> - Commandes</a>
    ...
    <a href='/dashboard/produits' class='text-dark mt-3 @if(Request::is('*/produits*')) active @endif'><img src='{{asset('images/icons/nappy2.svg')}}' style='width:2.4rem;'> - Produits</a>
    ...
    <a href='/dashboard/clients' class='text-dark mt-3 @if(Request::is('*/clients*')) active @endif'><img src='{{asset('images/icons/customer5.svg')}}' style='width:2.4rem;'> - Clients</a>
    ...
    <a href='/dashboard/reductions' class='text-dark mt-3 @if(Request::is('*/reductions*')) active @endif'><img src='{{asset('images/icons/coupon4.svg')}}' style='width:2.4rem;'> - Réductions</a>
    <a href='/dashboard/newsletters' class='text-dark mt-3 @if(Request::is('*/newsletters*')) active @endif'><img src='{{asset('images/icons/newsletters2.svg')}}' style='width:2.4rem;'> - Newsletters</a>
</div>