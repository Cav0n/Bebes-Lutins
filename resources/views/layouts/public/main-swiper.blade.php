<div id='swiper-container' class="row d-none d-md-flex">
    ...
    <div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            <!-- Slides -->
            <div class="swiper-slide" onclick='load_url("/categories/TE2-Tout-en-deux-evolutive")'><img style='height:100%;width:100%;' src='{{asset('images/swiper/main/NewCollection.jpg')}}'></div>
