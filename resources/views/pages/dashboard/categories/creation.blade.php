                ...
                <div class="col-8">
                    ...
                    <div class="form-group m-0">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error('rank') is-invalid @enderror" name="rank" id="rank" aria-describedby="helpRank" placeholder="" min="0" step="1" value='{{old('rank')}}' required>
                            @error('rank')
                                <div class="invalid-feedback">{{$message}}</div>
                            @enderror
                        </div>
