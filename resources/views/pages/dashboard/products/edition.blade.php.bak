    ...
    <div class="card-body">
        <form action='/dashboard/produits/edition/{{$product->id}}' method="POST">
            ...
            <div class="form-group">
                ...
                <input id='categories' class="form-control @error('categories') is-invalid @enderror" name='categories' value='@foreach($product->categories as $category) {{$category->name}}, @endforeach' placeholder="Tapez le nom d'une catégorie">
                @error('categories')
                    <div class="invalid-feedback">{{$message}}</div>
                @enderror 
            ...
            <div id="characteristics-container" class="my-2">
                ...
                <div class="characteristic p-3 border my-2">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="characteristics[{{$index}}][message]" id="message" aria-describedby="helpMessage" >{{$characteristic->message}}</textarea>
