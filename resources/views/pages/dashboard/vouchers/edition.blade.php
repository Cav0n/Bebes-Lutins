...
<div class="card bg-white my-3">
    ...
    <div class="card-body">
        <form action='/dashboard/reductions/edition/{{$voucher->id}}' method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('code') is-invalid @enderror" name="code" id="code" aria-describedby="helpCode" placeholder="" required value='{{old("code", $voucher->code)}}'>
                @error('code')
            ...
            <div class="row m-0">
                <div class="col-6 pl-0">
                    <div class="form-group">
                        ...
                        <input type="text" name="minimal-price" id="minimal-price" class="form-control @error('minimal-price') is-invalid @enderror" placeholder="" aria-describedby="helpMinimalPrice" value='{{old("minimal-price", $voucher->minimalPrice)}}'>
                        @error('minimal-price')
                            <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                ...
                <div class="col-6 pr-0">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('max-usage') is-invalid @enderror" name="max-usage" id="max-usage" aria-describedby="helpMaxUsage" placeholder="" value='{{old("max-usage", $voucher->maxUsage)}}'>
                        @error('max-usage')
                            <div class="invalid-feedback">{{$message}}</div>
                        @enderror
