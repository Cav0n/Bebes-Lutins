                ...
                <table id="order-table">
                    ...
                    foreach ($orders as $order) {
                        ...
                        <tr class="<?php if($order->getStatus() == 0) echo "yellow"; ?>">
                            ...
                            <td onclick="load_bill('<?php echo $order->getId(); ?>')"  class="customer"><a href="https://www.bebes-lutins.fr/dashboard/page-client/<?php echo $order->getCustomer()->getId(); ?>"><?php echo ucfirst($order->getCustomer()->getFirstname()) . " " . strtoupper($order->getCustomer()->getSurname()); ?></a></td>
