...
<main>
    <div class="pre-page-title horizontal between">
        <a href="https://www.bebes-lutins.fr/dashboard4/produits/nouveau"><i class="fas fa-angle-left"></i> Nouveau produit</a>
    </div>
    <div class="page-title-container horizontal between">
        <h2>Importer un produit</h2>
    </div>
    <div class="window">
            ...
            <div class="table-container">
                <table id="product-table">
                    ...
                    foreach ($products as $product) { ?>
                        <tr onclick="importProduct('<?php echo $product->getId(); ?>')">
                            ...
                            <td class="name left"><a><?php echo $product->getName(); ?></a></td>
...
<script>
    function importProduct(id){
        document.location.href = "https://www.bebes-lutins.fr/dashboard4/produits/nouveau/"+id;
    }
