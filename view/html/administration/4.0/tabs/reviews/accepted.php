...
$accepted_reviews = ReviewGateway::GetAllAcceptedReview();
    ...
    <div class="window">
        <div class="window-header">
            <div class="window-tabs">
                <a href="https://www.bebes-lutins.fr/dashboard4/avis/tous-les-avis/acceptes" class="tab vertical centered selected">Avis acceptés</a>
                <a href="https://www.bebes-lutins.fr/dashboard4/avis/tous-les-avis/rejetes" class="tab vertical centered">Avis rejetés</a>
            </div>
        </div>
        <div class="window-inner">
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody>
                    <?php
                    foreach ($accepted_reviews as $accepted_review) { $accepted_review = ReviewContainer::GetReview($accepted_review)
                            ?>
                            <tr>
