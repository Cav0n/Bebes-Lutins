...
$vouchers = VoucherGateway::GetActiveVoucher();
    ...
    <div class="window">
        <div class="window-header">
            <div class="window-tabs">
                ...
                <a href="https://www.bebes-lutins.fr/dashboard4/reductions/tous-les-codes/actifs" class="tab vertical centered selected">Actifs</a>
