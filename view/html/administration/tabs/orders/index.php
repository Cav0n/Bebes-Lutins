    ...
    <div id="disp-orders" class="horizontal between windows-container selected">
        ...
        <div class="vertical window" id="orders-window">
            <div id="window-tabs-orders" class="horizontal window-tabs">
                <p id="in-preparation-orders" class="tab selected transition-fast" onclick="tab_selection_changed_orders('payed')">Commande en attente</p>
            ...
            <div id="display-orders" class="tab-display">
                ...
                <?php } else foreach ($orders as $order) { $order = (new OrderContainer($order))->getOrder(); if ($order->getStatus() == 1) {
