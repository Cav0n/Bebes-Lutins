...
$reviews = ReviewGateway::GetAllDeclinedReview();
    ...
    <div id="display-windows" class="horizontal">
        <div id="search-window">
            ...
            <div id="search-choice-container" class="horizontal centered">
                <a href="https://www.bebes-lutins.fr/dashboard/tab/reviews/validated">Avis validés</a>
                <a class="selected" href="https://www.bebes-lutins.fr/dashboard/tab/reviews/declined">Avis refusés</a>
            </div>
