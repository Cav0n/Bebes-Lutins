    ...
    <div id="disp-users" class="horizontal between windows-container selected">
        <div class="vertical window" id="users-window">
            <div id="window-tabs-users" class="horizontal window-tabs">
                <p id="verified-accounts" class="tab selected transition-fast" onclick="tab_selection_changed_users('utilisateurs')">Comptes validés</p>
                <p id="administrators" class="tab non-selected transition-fast" onclick="tab_selection_changed_users('administrateurs')">Administrateurs</p>
            </div>
