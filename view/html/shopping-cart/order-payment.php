...
<html>
<head>
    <title>Paiement - Bebes Lutins</title>
    <meta name="description" content="Choisissez votre mode de paiement (carte bancaire ou chèque bancaire)."/>
...
<main id="shopping-cart-main">
    <div id="payment-wrapper" class="vertical">
        ...
        <div id="payment-inner" class="desktop horizontal centered">
            <div id="payment-container" class="vertical">
                <div id="payment-choice">
                    <form id="payment-method-form" method="post" action="https://www.bebes-lutins.fr/panier/paiement/init" class="vertical centered">
                        ...
                        <div id="start-payment" class="vertical centered margin-bottom">
                            ...
                            <button id="next-button" class="transition-fast" form="payment-method-form">Payer</button>
                        </div>
                    </form>
                </div>
            </div>
            <div id="order-summary-container" class="vertical">
                ...
                <div class="order-items vertical">
                    <!-- Affichage de la liste des produits de la commande et choix du moyen de paiement -->
        ...
        <div id="payment-inner-mobile" class="mobile vertical">
            <div id="payment-container" class="vertical">
                <form id="payment-method-form-mobile" method="post" action="https://www.bebes-lutins.fr/panier/paiement/init" class="vertical centered">
                    <label for="payment_method">Moyen de paiement :</label>
                    <select id="payment_method" name="payment_method">
                        <option value="1">Carte bancaire</option>
                        <option value="2">Chèque bancaire</option>
